...
//			if (renderer.material.mainTexture==null)
		...
		void MousePaint ()
		{
			...
			if (Input.GetMouseButtonDown(0))
			{
				...
				if (useLockArea)
				{
					if (!Physics.Raycast (Camera.main.ScreenPointToRay(Input.mousePosition), out hit, Mathf.Infinity, paintLayerMask)) return;
			...
			if (Input.GetMouseButton(0))
			{
				...
				if (!Physics.Raycast (Camera.main.ScreenPointToRay(Input.mousePosition), out hit, Mathf.Infinity, paintLayerMask)) {wentOutside=true; return;}
